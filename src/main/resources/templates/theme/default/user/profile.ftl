...
<@html page_title=user.username + " page" page_tab="user">
    <div class="row">
        <div class="col-md-9">
            <div class="card">
                <div class="card-body">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <div>Points：<a href="/top100">${user.score}</a></div>
                            <#if user.bio??>
                                <div><i class="gray">${user.bio!}</i></div>
                            </#if>
                            <div>Sujets favoris: <a href="/user/${user.username}/collects">${collectCount!0}</a></div>
                            <div>Temps d’occupation: ${model.formatDate(user.inTime)}</div>
                        </div>
                    </div>
                </div>
